...
const dz5Button = document
  .getElementById("dz5Button")
  .addEventListener("click", dz5);
const dz6Button = document
  .getElementById("dz6Button")
  .addEventListener("click", dz6);
